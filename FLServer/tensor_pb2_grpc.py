...
class FederatedLearningStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GlobalModel = channel.unary_unary(
                ...
                request_serializer=tensor__pb2.RefreshModel.SerializeToString,
                response_deserializer=tensor__pb2.ModelResponse.FromString,
                _registered_method=True)
...
def add_FederatedLearningServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'GlobalModel': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=tensor__pb2.RefreshModel.FromString,
                    response_serializer=tensor__pb2.ModelResponse.SerializeToString,
            ),
...
class FederatedLearning(object):
    ...
    def GlobalModel(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/grpc.FederatedLearning/GlobalModel',
            tensor__pb2.RefreshModel.SerializeToString,
            tensor__pb2.ModelResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
